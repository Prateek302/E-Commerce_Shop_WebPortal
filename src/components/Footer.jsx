...
const Footer = () => {
  return (
    <section className="py-10 bg-gray-50 dark:bg-gray-800 sm:pt-16 lg:pt-24">
        ...
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
          <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
            ...
            <p className="text-base leading-relaxed text-gray-600 dark:text-gray-300 mt-7">
              <b>Bihar Fire Protection</b>
              <br /> Best Fire Equipement seller shop
            </p>
            ...
            <ul className="flex items-center space-x-3 mt-9">
              <li>
                <a
                  href="#"
                  title=""
                  className="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600 hover:scale-105 transform"
                >
                  <svg
                    className="w-4 h-4"
