  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-800 py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-lg space-y-6">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Bihar Fire Protection, Maa Tetar
                Niwas Gandhi Nagar, Ashiana Nagar, Patna, Bihar 800025.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Bihar Fire Protection,
                accessible from{" "}
                <a
                  href="https://www.biharfireprotection.in/"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://www.biharfireprotection.in/
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>By email: biharfireprotection@yahoo.com</li>
          </ul>
        </div>
      </div>
    </div>
